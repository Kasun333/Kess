        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-heading font-bold text-xl text-white">KESS</span>
            </div>
          ...
          {/* Column 3 - Support */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary-500">Support KESS</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="/support#donate" className="text-gray-400 hover:text-white transition-colors">
                  Donate
                </Link>
              </li>
              <li>
                <Link href="/support#volunteer" className="text-gray-400 hover:text-white transition-colors">
                  Volunteer
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-gray-400">info@kess.org</span>
              </li>
              <li className="flex items-start space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Kegalle Engineering Students' Society. All rights reserved.
            </p>
